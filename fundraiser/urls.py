...
from team_fundraising.admin import DonorCsv, DonorYearCsv
...
urlpatterns = [
    ...
    path(
        'admin/donation_report_csv/year/<int:year>/',
        staff_member_required(DonorYearCsv.as_view()),
        name="donation_report_year_csv"
    ),
